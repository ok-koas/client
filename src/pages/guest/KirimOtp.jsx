	...
	return (
		<div className="flex items-center justify-center min-h-screen bg-gray-100">
			<form className="w-64 md:w-80 lg:w-96 h-auto bg-white flex flex-col items-center justify-center p-5 gap-5 relative shadow-md rounded-lg">
				...
				<button
					className="w-full h-8 md:h-10 lg:h-12 bg-blue-500 text-white font-semibold rounded-md cursor-pointer hover:bg-blue-600 transition duration-200"
					type="submit"
				>
					Verify
				</button>
				<p className="text-xs md:text-sm lg:text-base text-black w-full flex flex-col items-center justify-center gap-1">
					...
					<form action="" method="post">
						<button
							className="bg-transparent border-none text-blue-500 cursor-pointer text-lg font-bold"
							type="submit"
						>
							Resend Code
						</button>
