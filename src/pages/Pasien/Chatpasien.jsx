...
const Chatpasien = () => {
  ...
  const [view, setView] = useState('welcome'); // Default view is welcome
  const [showMenu, setShowMenu] = useState(false); // State to manage dropdown menu
          ...
          <div className="relative">
            ...
            {showMenu && (
              <div className="absolute right-0 mt-2 w-32 bg-white shadow-lg rounded-md p-2 z-10">
                <button onClick={handleBack} className="block w-full text-left p-2 hover:bg-gray-100 rounded">Kembali</button>
          ...
          <>
            <div className="flex items-center mb-6">
              <img
                ...
                alt="Dokter"
              />
              <p className="text-lg font-semibold">Dokter</p>
            </div>
