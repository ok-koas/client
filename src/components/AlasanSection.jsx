const AlasanSection = () => {
	return (
		<section className="text-center py-5 mx-5 bg-accent grid grid-cols-10">
			<h2 className="text-lg md:text-3xl font-bold mb-4 col-start-2 col-span-8">
				Kenapa <span className="text-neutral-content">OK</span>
			...
			<p className="text-sm md:text-lg mx-auto max-w-full md:max-w-2xl col-start-2 col-span-8">
				...
				<span className="text-secondary">-Koas</span> memudahkan mahasiswa koas
